        ...
        <aside class="right-side">
            ...
            <section class="content">
                <div class="row">
                    ...
                    <div id="counter_container" style="width:100%; background: white; border-radius: 5px; padding: 10px;">
                        <div id="text_above_timer" style="font-family: &quot;Open Sans&quot;; font-weight: normal; font-size: 22px; line-height: 22px; color: rgb(0, 0, 0); text-align: center; display: block;">Hurry! Only 
                            <span id="scarcitynumber" style="background-color: rgb(255, 255, 255); color: rgb(169, 68, 66);	border-radius: 5px;">11</span> left in stock
                        </div>
                        ...
                        <div id="just_bought" style="display:none;">
                        </div>
                        <div id="my-counter" class="simple-timer clock">
                              <div class="mycountdown">
                                <div class="timer-hour value">02</div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="ex8" name="slider_margin" class="slider form-control" data-slider-id='ex8' type="text" data-slider-min="0" data-slider-handle="square" data-slider-max="20" data-slider-step="1" data-slider-value="14" />
                                                    </div>
